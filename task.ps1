...
-SshKeyName $sshKeyName -PublicIpAddressName $publicIpAddressName -Credential $vmCredential
...
Set-AzVMExtension `
    ...
    -Settings @{
        fileUris = @("https://raw.githubusercontent.com/TrickyTenshi/azure_task_12_deploy_app_with_vm_extention/main/install-app.sh")
